...
public class Member {
	...
	// 1. 생성자 이름은 클래스명과 같다 
	// 2. 반환형이 없다.
	// ** 기본생성자는 컴파일러가 자동으로 생성해주는데, 다른 생성자가 하나라도
	// 있으면 자동생성 안해줌
	...
	public String getMemberId() {
		// 반환형 : String 자료형을 해당 메서드를 호출한 쪽으로 돌려보내겠다.
	...
	// setter : 세팅해는애, 무엇을 세팅할지 전달받아온 것이 매개변수인가.
	public void setMemberId(String memberId) {// String memberId 전달받아온 것
		// 반환형 void : 반환값이 없다.
		this.memberId = memberId; //앞에 있는건 필드, 뒤에있는건 멤버변수
		
		// 모든 메서드는 종료 시 호출한 곳으로 돌아가는
		// return; 구문이 작성되어야 하지만,
		// void일 경우 컴파일러가 자동 return 추가해준다. 우리 눈에만 안보임
	}
