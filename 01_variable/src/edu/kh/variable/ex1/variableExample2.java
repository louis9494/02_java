...
public class variableExample2 {
	...
	public static void main(String[] args) {
		...
		booleanData = true; // booleanData를 변수에 true 논리값 집어넣기 (대입)
		
		System.out.println("booleanData : " + booleanData);
		
		
		
		byte byteNumber = 127; //128 에러뜸
		// 메모리에 정수값을 저장할 공간을 1byte 할당하고
		// 할당된 공간을 byteNumber 라고 부르겠다
		// 선언됨 byteNumber 변수에 처음으로 127을 넣음.
		// --> 초기화 : 처음 변수에 값을 대입
		...
		// 프로그래밍에서 대입되는 데이터(값자체)를 리터럴 이라는 단어로도 표현
		 ...
		 * -> 반대로 생각하면 변수에 66이라는 숫자를 저장하는 것이 가능함.
		 * 
		 * 
		 * */
		...
		int $intNumber; // 문제는 없지만 개발자는 이렇게 작성 안함..
