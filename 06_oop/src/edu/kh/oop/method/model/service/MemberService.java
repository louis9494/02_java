...
public class MemberService {
	...
	private Member loginMember = null; // 로그인한 외원의 정보를 저장할 변수
	// 기능 (생성자,메서드)
	...
	public String login() {
		...
		if( memberId.equals(memberInfo.getMemberId()) &&
			...
			return "아이디 또는 비밀번호가 일치하지 않습니다!";//오류 사라지게 하는법
	...
	public String SelectMember() {
		...
		//return  loginMember.getMemberName() + loginMember.getMemberId() + loginMember.getMemberAge();
