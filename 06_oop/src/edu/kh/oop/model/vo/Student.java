...
//[접근제한자] [예약어] class 클래스명 
		...
		// == 멤버 변수 : 메서드 밖에 작성된 변수 (안쪽은 지역변수)
		
		// 인스턴스 변수 : 필드에 작성되는 일반 변수
		// ex) private int age;
		
		// 클래스 변수 ( == static 변수) : 필드에 static 예약어가 작성된 변수
		// ex) public static String schoolName; -> static은 보통 public을 많이씀
	...
	// final 예약어 
	private final int TEMP1 = 100; //전부 다 대문자로 만들어야됨
	...
	public void ex() {
		...
		// 필드 접근제한자 확인하기
		// v1~4까지 전부 Student 클래스 내부에서 생성된 변수이기 때문에 작동가능
