...
public class ArrayExample1 { // 예제 작성용 클래스
	...
	public void ex1() {
		...
		// new : "new연산자"라고 하며 Heap 메모리 영역에 새로운 공간(배열, 객체)을 할당하겠다라는 의미
		...
		/*heap영역에 할단된 공간은 절대 비어있을 수 없다.
		-> 최초 할당시 jvm 기본값이 자동 저장된다.
	...
	public void ex3() {
		...
		for(int i = 0; i < height.length; i++) {
			...
			System.out.print( (i+1) + "번 키 입력 : "); // 1 -> 1 2 3 4 5 
	...
	public void ex6() {
		...
		String[] arr = {"김밥", "라면", "서브웨이", "햄버거", "짬뽕", "타코", "초밥"};
...
//		        01234	
		...
		String input = sc.nextLine(); // hello world [h,e,l,l,o, ,w,o,f,l,d]
		...
		// 2. 문자하나를 입력받아 일치하는 문자가 char 배열에 볓개 존재하는지 확인
		System.out.print("검색할 문자 입력 : ");
		char ch = sc.next().charAt(0);
		// sc.next() -> String 형
		// String.charAt(0) -> String의 0번째 인덱스 문자 하난를 추출해서 char 형태로 반환
		// "h" -> 'h'
