...
public class PolyService {
	...
	public void ex1() {
		...
		// Tesla 객체를 참조하는 변수(car2)의 타입이 Car(부모)이기 때문에
		...
		// 전달받은Car 또는 자식객체(Tesla, Spark)의 엔진, 연료, 바퀴갯수를 출력 메서드 
	public void printCar(Car temp) {
		...
		// Car temp = s
		// 다형성의 업캐스팅 모양과 똑같다
		// -> temp라는 매개변수에는 테슬라,스파크,Car의 주소가 넘어와도 된다(업캐스팅)
	...
	public void ex2() {
		...
		System.out.println( arr[1] instanceof Tesla ); // true 본인
	...
	public void ex3() {
		...
		// 자식객채의 본래 필드, 메서드를 사용 가능하게 한다.
		
		Car c1 = new Tesla("전기모터", "전기",4, 50000);
		// 업캐스팅 상태 ( Tesla 자식 -> Car 부모 인척 한다)
		
		System.out.println(((Tesla)c1).getBatteryCapacity() );
		// 주의 !
		// "." 연산자가 형변환 연산자보다 우선순위 높음
	...
	public void ex4() {
		...
		// 런타임 에러 : 프로그램 실행 시 시켜봐야 에러인줄 앎 예외(에러)
		// 컴파일 에러 : 실행 전 코드에 빨간줄 에러
		
		// 해결방법 : instanceof 와 같이 사용해야한다! (예외처리)
	...
	public void ex5() {
		...
		// 하지만 실제로 실행해보면  자식(Spark)의 toString()이 호출되는것을 확인
		// 경차엔진  / 휘발유  / 4 / 0.5
